describe('A binary-search', function () {
    describe('on a small array', function () {
        it('should find the index when the target is greater than the guess', function () {
        ...
        it('should find the index when the target is less than the guess', function () {
            var arrayOfSix = [2, 3, 5, 7, 11, 13, 17];
        ...
        it('should find the index of an array of ten', function () {
    ...
    describe('on a big array', function () {
        var bigArray;
        beforeEach(function () {
